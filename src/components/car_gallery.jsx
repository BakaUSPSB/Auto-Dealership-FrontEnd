...
const CarGallery = () => {
  ...
  const renderPlaceholders = () => {
    return Array.from({ length: itemsPerPage }, (_, index) => (
      <Col key={index} xs={12} sm={6} md={4} lg={3} xl={2} className="d-flex align-items-stretch">
        <Card style={{ width: '250px', minWidth: '250px', height: '300px', margin: '1rem', backgroundColor: 'grey' }}>
          <Card.Body>
  ...
  return (
    <Container fluid>
      <Row>
        <Col md={3} style={{ width: '300px', minWidth: '300px' , backgroundColor: 'blueviolet'}}>
          {/* Filter section */}
          <Form>
